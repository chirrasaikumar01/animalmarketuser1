...
class SuccessfullyCreatedCropView extends StatefulWidget {
  final SuccessArgument argument;

  const SuccessfullyCreatedCropView({super.key, required this.argument});

  @override
  State<SuccessfullyCreatedCropView> createState() => _SuccessfullyCreatedCropViewState();
}

class _SuccessfullyCreatedCropViewState extends State<SuccessfullyCreatedCropView> {
  @override
          ...
          child: Wrap(
            children: [
              CustomButtonWidget(
                ...
                onPressed: () {
                  final link = DeepLinkService().generateDeePLink(widget.argument.subCategoryId, widget.argument.id.toString(), "Crop");
