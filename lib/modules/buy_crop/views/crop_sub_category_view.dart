...
class CropSubCategoryView extends StatefulWidget {
  final CropArgument argument;

  const CropSubCategoryView({super.key, required this.argument});

  @override
  State<CropSubCategoryView> createState() => _CropSubCategoryViewState();
}

class _CropSubCategoryViewState extends State<CropSubCategoryView> {
  late BuyCropProvider buyProvider;

  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      buyProvider = context.read<BuyCropProvider>();
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.pushNamed(context, Routes.marketCrop, arguments: CropArgument(id: item.id.toString(), isUser: false, categoryId: widget.argument.categoryId));
                            },
                            child: Column(
                              children: [
                                Container(
