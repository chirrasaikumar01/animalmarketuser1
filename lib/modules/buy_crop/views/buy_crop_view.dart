...
class BuyCropView extends StatefulWidget {
  final String categoryId;

  const BuyCropView({super.key, required this.categoryId});

  @override
  State<BuyCropView> createState() => _BuyCropViewState();
}

class _BuyCropViewState extends State<BuyCropView> {
  late BuyCropProvider buyCropProvider;

  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      buyCropProvider = context.read<BuyCropProvider>();
      buyCropProvider.buyCattleHome(context, widget.categoryId);
    });
    super.initState();
  }
  ...
  @override
  void dispose() {
    buyCropProvider.isLoading = true;
    super.dispose();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<BuyCropProvider>(builder: (context, state, child) {
      return Scaffold(
          ...
          return SingleChildScrollView(
            child: Column(
              children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.pushNamed(context, Routes.cropSubCategory, arguments: CropArgument(id: widget.categoryId, isUser: false, categoryId: widget.categoryId));
                            },
                            child: Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, Routes.marketCrop, arguments: CropArgument(id: item.id.toString(), isUser: false, categoryId: widget.categoryId));
                              },
                              child: Column(
                                children: [
                                  Container(
                ...
                Visibility(
                  visible: state.cropNearYou.isEmpty ? false : true,
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, Routes.marketCrop, arguments: CropArgument(id: "", isUser: false, categoryId: widget.categoryId));
                              },
                              child: Container(
                                padding: EdgeInsets.symmetric(horizontal: 6.w, vertical: 3.h),
                                decoration: BoxDecoration(
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          itemCount: state.cropNearYou.length,
                          shrinkWrap: true,
                          physics: const BouncingScrollPhysics(),
                          scrollDirection: Axis.horizontal,
                          itemBuilder: (BuildContext context, int index) {
                            var item = state.cropNearYou[index];
                            return GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, Routes.marketCropDetails, arguments: CropArgument(id: item.id.toString(), isUser: false, categoryId: widget.categoryId));
                              },
                              child: Container(
                                width: 146.w,
                                height: 200.h,
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CustomImage(
                                        ...
                                        errorAsset: ImageConstant.cropDemoImg,
                                        radius: 10.dm,
                                        imageUrl: item.cattleImages != null && item.cattleImages!.isNotEmpty ? item.cattleImages![0].image.toString() : "",
                                        baseUrl: ApiUrl.imageUrl,
                                        height: 105.h,
                                        width: double.infinity,
                                        fit: BoxFit.fill,
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          if (result != null) {
                            if (context.mounted) {
                              Provider.of<MarketProvider>(context, listen: false).locationUpdate(context, result, widget.categoryId);
                            }
                          } else {
