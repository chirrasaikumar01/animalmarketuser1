...
class SellView extends StatefulWidget {
  ...
  const SellView({super.key, required this.categoryId});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(context, Routes.addSellProducts, arguments: AddSellProductsArguments(isEdit: false, categoryId: widget.categoryId, id: ''));
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(context, Routes.productsDashboard);
                    },
