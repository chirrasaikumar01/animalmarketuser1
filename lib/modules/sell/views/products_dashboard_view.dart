...
import 'package:animal_market/modules/sell/widgets/all_product_list_widget.dart';
...
class ProductsDashboardView extends StatefulWidget {
  const ProductsDashboardView({super.key});

  @override
  State<ProductsDashboardView> createState() => _ProductsDashboardViewState();
}

class _ProductsDashboardViewState extends State<ProductsDashboardView> {
  int index = 0;
  ...
  Widget build(BuildContext context) {
    return Consumer<SellProductsProvider>(builder: (context, state, child) {
      return SafeArea(
        child: Scaffold(
              ...
              : PreferredSize(
                  ...
                  child: CommonAppBar(
                    ...
                    action: GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, Routes.addSellProducts, arguments: AddSellProductsArguments(isEdit: false, categoryId: state.categoryId, id: ''));
                      },
                      child: Container(
...
class _ProductsDashboardState extends State<ProductsDashboard> {
  late SellProductsProvider sellProductsProvider;
  int index = 0;
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      sellProductsProvider = context.read<SellProductsProvider>();
  ...
  Widget _buildTabBar(SellProductsProvider state) {
    return Container(
      color: Colors.white,
  ...
  Widget _buildTabContent(SellProductsProvider state) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 12.w),
