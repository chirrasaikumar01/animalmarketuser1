...
class SellProfileContainer extends StatefulWidget {
  ...
  const SellProfileContainer({super.key, required this.seller, required this.totalListed, required this.totalCallsReceived, required this.totalViewsReceived, required this.listedName});
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Image.asset(
                              widget.listedName ==Provider.of<TranslationsProvider>(context, listen: false).tr("petListed")
                                  ? ImageConstant.dogHouseIc
                                  : widget.listedName == Provider.of<TranslationsProvider>(context, listen: false).tr("cropListed")
