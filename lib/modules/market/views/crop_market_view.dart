...
import 'package:animal_market/modules/market/widgets/filter_crop_bottom_sheet.dart';
...
class CropMarketView extends StatefulWidget {
  final CropArgument argument;

  const CropMarketView({super.key, required this.argument});

  @override
  State<CropMarketView> createState() => _CropMarketViewState();
}

class _CropMarketViewState extends State<CropMarketView> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      provider.cropListGet(context, false, true);
  ...
  Widget build(BuildContext context) {
    return Consumer<MarketProvider>(builder: (context, state, child) {
      return SafeArea(
        child: Scaffold(
          backgroundColor: ColorConstant.white,
          appBar: PreferredSize(
            preferredSize: Size(double.infinity, 70.h),
            child: CommonAppBar(title: "cropMarketplace"),
          ),
          body: Padding(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        FilterCropBottomSheet.show(context, () {
                          state.cropListGet(context, true, false);
                        });
                      },
                      child: Container(
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(context, Routes.marketCropDetails, arguments: CropArgument(id: item.id.toString(), isUser: false, categoryId: widget.argument.categoryId));
                          },
                          child: Container(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                ...
                                                final imageUrl = item.cropImages != null && item.cropImages!.isNotEmpty && item.cropImages![0].type == "Image" ? item.cropImages![0].image : "";
                                      ...
                                      GestureDetector(
                                        onTap: () async {
                                          ...
                                          if (await launchUrl(Uri.parse(url))) {
                                            ...
                                            Provider.of<OtherSellerProvider>(context, listen: false).increaseCallCount("crop", item.id.toString());
                                          } else {
