...
class AllProductPetListWidget extends StatefulWidget {
  final String type;
  final String categoryId;
  final List<PatDetailsModel> cattleList;

  const AllProductPetListWidget({super.key, required this.type, required this.cattleList, required this.categoryId});

  @override
  State<AllProductPetListWidget> createState() => _AllProductPetListWidgetState();
}

class _AllProductPetListWidgetState extends State<AllProductPetListWidget> {
  @override
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, Routes.petMarketDetails, arguments: PetArgument(id: item.id.toString(), isUser: true, categoryId: widget.categoryId));
          },
          child: Container(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: CustomImage(
                        ...
                        radius: 10.dm,
                        imageUrl: item.petImages != null && item.petImages!.isNotEmpty ? item.petImages![0].path : "",
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              onTap: () {
                                Provider.of<PetSellProductsProvider>(context, listen: false).petMarkToSold(context, item.id.toString());
                              },
                              child: Container(
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, Routes.addPetSellProducts,
                                    arguments: AddPetSellProductsArguments(
                                      isEdit: true,
                            ...
                            child: GestureDetector(
                              onTap: () {
                                DeleteProductBottomSheet.show(context, () {
                                  Provider.of<PetSellProductsProvider>(context, listen: false).petDelete(context, item.id.toString());
                                });
                              },
                              child: Container(
                                padding: EdgeInsets.symmetric(horizontal: 6.w, vertical: 8.h),
