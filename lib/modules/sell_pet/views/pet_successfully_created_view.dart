...
class PetSuccessfullyCreatedView extends StatefulWidget {
  final PetSuccessArgument argument;

  const PetSuccessfullyCreatedView({super.key, required this.argument});

  @override
  State<PetSuccessfullyCreatedView> createState() =>
      _PetSuccessfullyCreatedViewState();
}

class _PetSuccessfullyCreatedViewState
    extends State<PetSuccessfullyCreatedView> {
  @override
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              TText(
                keyName: "petIsUnderVerification",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 14.sp,
                  fontWeight: FontWeight.w600,
              ...
              CustomButtonWidget(
                ...
                onPressed: () {
                  final link = DeepLinkService().generateDeePLink(
                      widget.argument.subCategoryId,
                      widget.argument.id.toString(),
                      "Pet");
                  final imageUrl = widget.argument.image.isNotEmpty
